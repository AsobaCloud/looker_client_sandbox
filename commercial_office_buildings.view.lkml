view: commercial_office_buildings {
  sql_table_name: ATTOM_PROPERTY_DATA.COMMERCIAL_OFFICE_BUILDINGS ;;
  ...
  measure: average_cost_per_square_foot {
    type: average
    sql: ${assd_ttl_value}/${universal_size} ;;
    value_format: "$0.00 \"/sq ft\""
  }
